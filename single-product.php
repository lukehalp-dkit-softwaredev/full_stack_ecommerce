            ...
            <section class="product_description_area">
                <div class="container">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="product_description_tab" data-toggle="tab" href="#ag_product_description" role="tab" aria-controls="home" aria-selected="true">Description</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade" id="ag_product_description" role="tabpanel" aria-labelledby="home-tab">&nbsp;</div>
